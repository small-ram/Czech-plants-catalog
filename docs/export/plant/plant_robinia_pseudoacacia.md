...
- Plant ID: plant_robinia_pseudoacacia
- Vědecký název: Robinia pseudoacacia
- Status v ČR: nepůvodní, zdomácnělý a běžný
- Počet použití: 1
- Trvanlivá použití: 1
- Jádrová použití: 0
...
### R267 · květy vařené / nápoj / zavařenina
...
- S102 · PFAF: Robinia pseudoacacia · https://pfaf.org/user/Plant.aspx?LatinName=robinia_pseudoacacia (1 použití)
