...
def build_data(db_path: Path, docs_dir: Path) -> dict[str, object]:
    ...
    for row in uses_rows:
        ...
        index_row = {
            ...
            "hlavni_prinos_text": detail.get("hlavni_prinos_text"),
    ...
    for plant in plants_rows:
        ...
        payload["uses"] = [
            {
                ...
                "hlavni_prinos_text": use.get("hlavni_prinos_text"),
                "aktivni_latky_text": use.get("aktivni_latky_text"),
                "latky_a_logika_text": use.get("latky_a_logika_text"),
                "funkcni_kontext_status": use.get("funkcni_kontext_status"),
        ...
        index_row = {
            ...
            "hlavni_prinos_text": plant.get("hlavni_prinos_text"),
            "aktivni_latky_text": plant.get("aktivni_latky_text"),
            "latky_a_logika_text": plant.get("latky_a_logika_text"),
            "funkcni_kontext_status": plant.get("funkcni_kontext_status"),
        ...
        index_row["search_text"] = " ".join(
            ...
            for value in [
                ...
                plant.get("hlavni_prinos_text"),
                plant.get("aktivni_latky_text"),
                plant.get("latky_a_logika_text"),
            ]
            if value
        )
