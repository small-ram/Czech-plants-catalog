      ...
      <main class="layout">
        <section class="filters-panel">
          ...
          <div class="grid-two">
            ...
            <label class="field">
              <span>Kategorie použití</span>
              <select id="subdomain_category">
                <option value="">Vše</option>
              </select>
            </label>
          </div>
        ...
        <section class="filters-panel">
          ...
          <div class="checks">
            ...
            <label class="check">
              ...
              <span>Jen rostliny s položkou v praktickém jádru</span>
            </label>
          </div>
        </section>
